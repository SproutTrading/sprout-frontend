    ...
    >
      <div className="h-full flex flex-col">
        ...
        <div className="flex items-center justify-between p-4 border-b border-emerald-100">
          <h2 className="text-lg font-semibold text-emerald-800">{token.token.name}</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex border-b border-emerald-100">
          <button
            ...
            className={`flex-1 px-4 py-3 text-sm font-medium transition-colors ${activeTab === 'buy'
          ...
          <button
            ...
            className={`flex-1 px-4 py-3 text-sm font-medium transition-colors ${activeTab === 'contribute'
                ? 'text-emerald-800 border-b-2 border-emerald-500'
                : 'text-emerald-600 hover:text-emerald-700'
              }`}
          >
